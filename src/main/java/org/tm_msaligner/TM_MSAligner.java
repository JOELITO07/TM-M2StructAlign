...
public class TM_MSAligner extends AbstractAlgorithmRunner {
    ...
    public static void main(String[] args) throws JMetalException, IOException {
        ...
        String dataDirectory = "D:\\Nube\\TM-MSA\\TM-MSAligner\\resources\\custom_tests\\msl\\"; //args[0]; // 
        String problemName = "msl"; //args[1]; // 
        Integer maxEvaluations = 25000; //Integer.parseInt(args[2]);  //25000
        ...
        int observerType = 0; //Integer.parseInt(args[5]);
        int frequencyObserver = 1; //Integer.parseInt(args[6]);
        ...
        org.tm_msaligner.algorithm.multiobjective.TM_M2Align tm_m2align = new TM_M2AlignBuilder(problem,
                            maxEvaluations,
                            populationSize,
