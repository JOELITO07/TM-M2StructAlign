...
public class StructTM_MSAFitnessWriteFileObserver<S extends StructuralTM_MSASolution> implements
   ...
   * Constructor
   */
  public StructTM_MSAFitnessWriteFileObserver(String fileNamePath, int plotUpdateFrequency)
      throws IOException {
