...
public class TM_MSAlignerGPCRdb extends AbstractAlgorithmRunner {
    ...
    public static void main(String[] args) throws JMetalException, IOException {
        ...
        String dataDirectory = args[0]; // "data/gpcrdb/classA"
        String problemName = args[1]; // "classA"
        ...
        List<String> preComputedFiles = getFastaFileNameListFromDir(dataDirectory +"precomputed/");
