...
public abstract class AbstractStructuralTM_MSAProblem<S> implements Problem<S> {

  private int numberOfVariables = 0;
  private int numberOfObjectives = 0;
  private String name = "Structural TM-MSA Problem";

  public AbstractStructuralTM_MSAProblem() {  }
